    ...
    <UserStyle>
      <FeatureTypeStyle>
        <Rule>
          <RasterSymbolizer>
            <ColorMap>
              <ColorMapEntry color="#ffffff" opacity="0" quantity="0.0" label="  0.0"/>              
              <ColorMapEntry color="#440356" opacity="0.4" quantity="0.001" label="  0.091"/>
              ...
              <ColorMapEntry color="#f3e528" opacity="1" quantity="1.0" label="  1.0"/>              
            </ColorMap>
          </RasterSymbolizer>
