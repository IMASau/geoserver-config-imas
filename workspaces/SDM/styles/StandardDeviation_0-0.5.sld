...
<StyledLayerDescriptor version="1.0.0" xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc"
  ...
  <NamedLayer>
    <Name>Model variance range 0-0.5</Name>
    <UserStyle>
      <FeatureTypeStyle>
        <Rule>
          <RasterSymbolizer>
            <ColorMap>
              ...
              <ColorMapEntry color="#b1d2e8" opacity="0.7" quantity="0.1"/>
              <ColorMapEntry color="#78b5d9" opacity="0.7" quantity="0.2"/>
              <ColorMapEntry color="#4191c6" opacity="0.7" quantity="0.3"/>
              <ColorMapEntry color="#1c67ad" opacity="0.7" quantity="0.4"/>   
              <ColorMapEntry color="#093f82" opacity="0.7" quantity="0.5"/>                            
            </ColorMap>
          </RasterSymbolizer>
        ...
        <Rule>
          <RasterSymbolizer>
            <ColorMap>
              ...
              <ColorMapEntry color="#093f82" opacity="1" quantity="0.5" label="  0.5"/>                
              <ColorMapEntry color="#1c67ad" opacity="1" quantity="0.4" label="  0.4"/>  
              <ColorMapEntry color="#4191c6" opacity="1" quantity="0.3" label="  0.3"/>              
              <ColorMapEntry color="#78b5d9" opacity="1" quantity="0.2" label="  0.2"/>   
              <ColorMapEntry color="#b1d2e8" opacity="1" quantity="0.1" label="  0.1"/> 
