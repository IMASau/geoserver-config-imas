...
<#list features as feature>
    ...
    <div class="feature"> 
        <b><span class="sea-lion-name" style="color: ${feature.colour.value} !important; font-size: 115%; display: inline-block; padding-bottom: 3px;"><i>${feature.name.value}</i></span></b> 
