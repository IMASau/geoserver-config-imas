...
<#list features as feature>
  ...
  <div class="feature">  
		...
		<b>Date:</b> ${feature.DateTime_AEDT.value[0..9]}<BR>
	...
	<h6>This information has been limited to five readings. There may be more data at this point. Proceed to download for the full data collection.</h6>
