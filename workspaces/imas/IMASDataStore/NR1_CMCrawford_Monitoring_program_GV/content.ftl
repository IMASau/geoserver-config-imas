...
<h3>This is a sample of the data collected at ${feature.ESTUARY.value} Estuary</h3><BR>
  ...
  <b>Total Nitrogen:</b> ${feature.NOX.value!"NA"} mg L<sup>-1</sup><BR>
  <b>Ammonia:</b> ${feature.AMMONIA.value!"NA"} mg L<sup>-1</sup><BR>  
  <b>Silicate:</b> ${feature.SILICATE.value!"NA"} mg L<sup>-1</sup><BR>
