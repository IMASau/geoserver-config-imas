...
<#list features as feature>
  ...
  <#if feature.Range.value?? && feature.Range.value?number != 0>
    ...
    <div class="feature" style="padding-top:5px; padding-bottom:5px; text-align:center;">
      ...
      <h6 style="margin-bottom:2px; font-style:italic;">Aetomylaeus caeruleofasciatus</h6>
      ...
      <#if feature["HabSuit_err05pct"]??>
        ...
        <#assign err10=feature["HabSuit_err10pct"].value?number>

        <#-- Only show the values if they are not nodata -->
        <#if !(err05 <= 0 && err10 <= 0)>
