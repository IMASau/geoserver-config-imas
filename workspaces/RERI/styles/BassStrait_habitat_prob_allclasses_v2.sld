      ...
      <FeatureTypeStyle>        
        <Rule>
          <RasterSymbolizer>
            <ChannelSelection>
              <GrayChannel>
                <SourceChannelName>5</SourceChannelName> <!-- Band 5 is BARE UNCONSOLIDATED habitat -->
              </GrayChannel>
            </ChannelSelection>            
            <ColorMap type="ramp">              
        ...
        <Rule>
          <RasterSymbolizer>
            <ChannelSelection>
              <GrayChannel>
                <SourceChannelName>2</SourceChannelName> <!-- Band 2 is MACROALGAE habitat -->
              </GrayChannel>
            </ChannelSelection>             
            <ColorMap type="ramp">              
        ...
        <Rule>
          <RasterSymbolizer>
            <ChannelSelection>
              <GrayChannel>
                <SourceChannelName>3</SourceChannelName> <!-- Band 3 is SEAGRASS habitat -->
              </GrayChannel>
            </ChannelSelection>            
            <ColorMap type="ramp">              
