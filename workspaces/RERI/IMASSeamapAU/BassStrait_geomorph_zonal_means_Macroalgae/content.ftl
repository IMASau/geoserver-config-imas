...
<#list features as feature>
  <#if feature_index < 3>
    ...
    <#assign probRaw = feature.MA_mean.value!>
    ...
    <div class="feature" style="padding-top:5px; padding-bottom:5px;">
      <#if feature_index == 0>
        <h5 style="padding-bottom:6px;">Macroalgae</h5>
      ...
      <div style="border-left:6px solid ${probColor}; padding-left:10px;">
        <ul style="margin:0; padding-left:14px; line-height:1.6em; list-style-position:outside;">
          ...
          <li style="padding-left:0px;">
            ...
            ">
              ${feature.MA_mean.value?number}
              <span style="font-style:italic;"> &#177; ${feature.MA_stdev.value?number}</span>
            </span>
          </li>
        </ul>
      </div>
