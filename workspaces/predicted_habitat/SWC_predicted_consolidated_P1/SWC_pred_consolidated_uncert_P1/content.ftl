            ...
            <div style="display: flex; align-items: center;"> 
                ...
                <#if grayIndexValue < 0.001>
                    ...
                    <div style="display: flex; align-items: center;"> 
                        ...
                        <span style="margin-left: 3px;"><i>No model simulations have forecast </i><b>bare consolidated substrata</b><br><i> to have an </i><b>0.0 or greater</b><i> probability of occurrence for this area.</i></span>
                    </div>
                <#else>
                    ...
                    <div style="display: flex; align-items: center;"> 
                        ...
                        <span style="margin-left: 8px;"><i>The model certainty of </i><b>bare consolidated substrata</b> <br><i>having an </i><b>0.0 or greater</b><i> probability of occurrence is </i><b>${(grayIndexValue * 100)?string("0.###")}%</b></i></span>
                    </div>
                </#if>
            </div>
        </div>
