...
<StyledLayerDescriptor version="1.0.0" xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc"
  ...
  <NamedLayer>
    <Name>Error in prediction (unconsolidated)</Name>
    <UserStyle>
      <FeatureTypeStyle>
        <Rule>
          <RasterSymbolizer>
            <ChannelSelection>
              <GrayChannel>
                <SourceChannelName>3</SourceChannelName> <!-- Band 3 is UNCONSOLIDATED habitat -->
              </GrayChannel>
            </ChannelSelection>             
            <ColorMap type="ramp">
        ...
        <Rule>
          ...
          <ColorMap type="ramp">              
              ...
              <ColorMapEntry color="#00619b" quantity="0" label="   0.000"/>    
