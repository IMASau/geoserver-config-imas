...
<StyledLayerDescriptor version="1.0.0" xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc"
  ...
  <NamedLayer>
    <Name>Model certainty of mean predicted occurrence (seagrass)</Name>
    <UserStyle>
      <FeatureTypeStyle>
        <Rule>
          <RasterSymbolizer>
        ...
        <Rule>
          <RasterSymbolizer>
            <ColorMap type="ramp">              
              <ColorMapEntry color="#ffffff" opacity="0.000001" quantity="200" label="Model certainty (seagrass)"/>
              ...
              <ColorMapEntry color="#02de70" opacity="0.5" quantity="0.4" label=" 0.4"/>
              <ColorMapEntry color="#02de70" opacity="0.3" quantity="0.2" label=" 0.2"/>
