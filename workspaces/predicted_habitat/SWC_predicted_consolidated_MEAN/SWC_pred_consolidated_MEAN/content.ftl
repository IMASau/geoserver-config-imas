            ...
            <div style="display: flex; align-items: center;"> 
                ...
                <#if grayIndexValue < 0.001>
                    ...
                    <div style="display: flex; align-items: center;"> 
                        ...
                        <span style="margin-left: 3px;"><i>No model simulations have predicted </i><b>bare consolidated substrata</b><br><i> to have an probability of occurrence exceeding the mean for this area.</i></span>
                    </div>
                <#else>
                    ...
                    <div style="display: flex; align-items: center;"> 
                        ...
                        <span style="margin-left: 8px;"><i>The model certainty of </i><b>bare consolidated substrata</b> <br><i>exceeding the mean probability of occurrence for this area is </i><b>${(grayIndexValue * 100)?string("0.###")}%</b></i></span>
                    </div>
                </#if>
            </div>
        </div>
