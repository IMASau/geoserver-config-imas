...
<p style="padding-top:5px; padding-bottom:5px">
	...
	<#elseif (raster_value >= 89) && (raster_value <= 92) || (raster_value >= 100) && (raster_value <= 103) || (raster_value >= 111) && (raster_value <= 114)>
             Probability of functional reef is <span style="color: #cc0000; font-weight: bold;">low</span> at this point,
             <br>
             and model predictions are <span style="color: #cc0000; font-weight: bold;">uncertain</span>.
