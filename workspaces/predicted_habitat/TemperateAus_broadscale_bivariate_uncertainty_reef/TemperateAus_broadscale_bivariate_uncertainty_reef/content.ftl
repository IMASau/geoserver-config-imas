...
<p style="padding-top:5px; padding-bottom:5px">
	...
	<#if (raster_value >= 97) && (raster_value <= 99) || (raster_value >= 108) && (raster_value <= 110) || (raster_value >= 119) && (raster_value <= 121)>
             <p>Probability of functional reef is <span style="color: #00b33c; font-weight: bold;">high</span> at this point,
             <br>
             but model predictions are <span style="color: #cc0000; font-weight: bold;">uncertain</span>.</p>
	...
	<#elseif (raster_value >= 93) && (raster_value <= 96) || (raster_value >= 104) && (raster_value <= 107) || (raster_value >= 115) && (raster_value <= 118)>
             <p>Probability of functional reef is <span style="color: #b3b300; font-weight: bold;">medium</span> at this point,
             <br>
             but model predictions are <span style="color: #cc0000; font-weight: bold;">uncertain</span>.</p>
	...
	<#elseif (raster_value >= 89) && (raster_value <= 92) || (raster_value >= 100) && (raster_value <= 103) || (raster_value >= 111) && (raster_value <= 114)>
             <p>Probability of functional reef is <span style="color: #cc0000; font-weight: bold;">low</span> at this point,
             <br>
             and model predictions are <span style="color: #cc0000; font-weight: bold;">uncertain</span>.</p>
	...
	<#elseif (raster_value >= 49) && (raster_value <= 52) || (raster_value >= 60) && (raster_value <= 63) || (raster_value >= 71) && (raster_value <= 74) || (raster_value >= 82) && (raster_value <= 85)>
             <p>Probability of functional reef is <span style="color: #b3b300; font-weight: bold;">medium</span> at this point,
             <br>
             and model predictions have a <span style="color: #b3b300; font-weight: bold;">moderate</span> certainty.</p>
	...
	<#elseif (raster_value >= 5) && (raster_value <= 8) || (raster_value >=16) && (raster_value <= 19) || (raster_value >= 27) && (raster_value<= 30) || (raster_value >= 38) && (raster_value <= 41)>
             <p>Probability of functional reef is <span style="color: #b3b300; font-weight: bold;">medium</span> at this point,
             <br>
             and model predictions have a <span style="color: #00b33c; font-weight: bold;">high</span> certainty.</p>
