            ...
            <div style="display: flex; align-items: center;"> 
                ...
                <#if grayIndexValue < 0.001>
                    ...
                    <div style="display: flex; align-items: center;"> 
                        ...
                        <span style="margin-left: 3px;"><i>No model simulations have predicted </i><b>bare consolidated substrata</b><br><i> to have an </i><b>0.2 or greater</b><i> probability of occurrence for this area.</i></span>
                    </div>
                <#else>
