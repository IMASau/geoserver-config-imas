...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>Intensity of threats to Pygmy Blue Whales: Pollution</Name>
    <UserStyle>
      <FeatureTypeStyle>
        ...
        <Rule>
          <RasterSymbolizer>
            ...
            <ColorMap type="ramp">
              ...
              <ColorMapEntry color="#ffffb2" quantity="0.003"/>           
        ...
        <Rule>
          <RasterSymbolizer>
            <ColorMap type="ramp">
              <ColorMapEntry color="#ffffff" opacity="0.000000000001" quantity="9999" label="Relative intensity (pollution)" />
