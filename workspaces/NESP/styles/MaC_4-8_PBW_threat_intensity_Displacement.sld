...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>Intensity of threats to Pygmy Blue Whales: Displacement</Name>
    <UserStyle>
      <FeatureTypeStyle>
        ...
        <Rule>
          <RasterSymbolizer>
            <ChannelSelection>
              <GrayChannel>
                <SourceChannelName>2</SourceChannelName> <!-- Band 2 is DISPLACEMENT -->
              </GrayChannel>
            </ChannelSelection>              
            <ColorMap type="ramp">
        ...
        <Rule>
          <RasterSymbolizer>
            <ColorMap type="ramp">
              <ColorMapEntry color="#ffffff" opacity="0.000000000001" quantity="9999" label="Relative intensity (displacement)" />
