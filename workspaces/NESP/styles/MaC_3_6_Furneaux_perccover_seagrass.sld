...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld"
      ...
      <FeatureTypeStyle>       
        <Rule>
          <RasterSymbolizer>
            ...
            <ChannelSelection>
              <GrayChannel>
                <SourceChannelName>6</SourceChannelName> <!-- Band 6 is SAND % cover -->
              </GrayChannel>
            </ChannelSelection>             
            <ColorMap type="ramp">
              <ColorMapEntry color="#fff876" opacity="1" quantity="0"/>
              <ColorMapEntry color="#fff876" opacity="1" quantity="0.2"/>              
              <ColorMapEntry color="#fff876" opacity="1" quantity="0.4"/>            
              <ColorMapEntry color="#fff876" opacity="1" quantity="0.6"/>
              <ColorMapEntry color="#fff876" opacity="1" quantity="0.8"/>
 ...
 <!-- Rule below is for the LENGEND ONLY - order is reversed -->        
      ...
      <!-- Seagrass ramp -->              
              ...
              <ColorMapEntry color="#02DC00" opacity="1" quantity="1" label=" low"/>
