...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>Exposure of Southern Right Whales to key threats: entanglement</Name>
    <UserStyle>
      <FeatureTypeStyle>
        ...
        <Rule>
          <RasterSymbolizer>
            <ChannelSelection>
              <GrayChannel>
                <SourceChannelName>2</SourceChannelName> <!-- Band 2 is ENTANGLEMENT -->
              </GrayChannel>
            </ChannelSelection>              
            <ColorMap type="ramp">
        ...
        <Rule>
          <RasterSymbolizer>
            <ColorMap type="ramp">
              <ColorMapEntry color="#ffffff" opacity="0.000000000001" quantity="9999" label="Exposure (entanglement)" />
