...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>Relative distribution of tracked Pygmy Blue Whales - April</Name>
    <UserStyle>
      <FeatureTypeStyle>
        ...
        <Rule>
          <RasterSymbolizer>
            <ChannelSelection>
              <GrayChannel>
                <SourceChannelName>4</SourceChannelName> <!-- Band 4 is April -->
              </GrayChannel>
            </ChannelSelection>             
            <ColorMap type="ramp">
        ...
        <Rule>
          <RasterSymbolizer>
            <ColorMap type="ramp">
              <ColorMapEntry color="#ffffff" opacity="0.000000000001" quantity="9999" label="Prob occurrence (April)"/>  
