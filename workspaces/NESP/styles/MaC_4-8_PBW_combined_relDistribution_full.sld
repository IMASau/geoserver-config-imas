        ...
        <Rule>
          <RasterSymbolizer>
            ...
            <ColorMap type="ramp">
              ...
              <ColorMapEntry color="#2782c4" quantity="0.08"/>                               
              <ColorMapEntry color="#a889b8" quantity="0.15" />              
              <ColorMapEntry color="#d78e9a" quantity="0.3" />                            
              <ColorMapEntry color="#ffa18e" quantity="0.5" />              
              <ColorMapEntry color="#ffcabf" quantity="0.75" />             
            </ColorMap>
          </RasterSymbolizer>
