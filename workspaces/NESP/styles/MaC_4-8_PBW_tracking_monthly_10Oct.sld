...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>Relative distribution of tracked Pygmy Blue Whales - October</Name>
    <UserStyle>
      <FeatureTypeStyle>
        ...
        <Rule>
          <RasterSymbolizer>
            <ColorMap type="ramp">
              <ColorMapEntry color="#ffffff" opacity="0.000000000001" quantity="9999" label="Prob occurrence (October)"/>  
