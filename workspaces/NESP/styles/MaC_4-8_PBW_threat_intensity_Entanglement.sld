...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>Intensity of threats to Pygmy Blue Whales: Entanglement</Name>
    <UserStyle>
      <FeatureTypeStyle>
        ...
        <Rule>
          <RasterSymbolizer>
            <ChannelSelection>
              <GrayChannel>
                <SourceChannelName>3</SourceChannelName> <!-- Band 3 is ENTANGLEMENT -->
              </GrayChannel>
            </ChannelSelection>              
            <ColorMap type="ramp">
        ...
        <Rule>
          <RasterSymbolizer>
            <ColorMap type="ramp">
              <ColorMapEntry color="#ffffff" opacity="0.000000000001" quantity="9999" label="Relative intensity (entanglement)" />
