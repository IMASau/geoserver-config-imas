...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>Exposure of Southern Right Whales to key threats: climate change</Name>
    <UserStyle>
      <FeatureTypeStyle>
        ...
        <Rule>
          <RasterSymbolizer>
            <ColorMap type="ramp">
              <ColorMapEntry color="#ffffff" opacity="0.000000000001" quantity="9999" label="Exposure (climate change)" />
