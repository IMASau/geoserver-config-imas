<#list features as feature>
    <#if (feature.GRAY_INDEX.rawValue > -1)>
        <#if (feature_index < 1)>
            ...
            <h5 style="padding-top: 3px; margin-bottom: -3px">Cumulative sound exposure from shipping - GBR</h5>
            <br>
            <div class="feature">
                ...
                <div style="margin-top: 8px;"> <!-- Adjust the space with this margin -->
                    <#if (noise < 128)>
                        <i>This represents a <span style="font-weight: bold; color: #1a75ff; font-style: normal;">very low</span> level of shipping noise.</i>
                    <#elseif (noise >= 128) && (noise < 135)>
                    ...
                    <#elseif (noise >= 174)>
                        <i>This represents a <span style="font-weight: bold; color: #b30086; font-style: normal;">very high</span> level of shipping noise.</i>
                    </#if>
                </div>
            </div>
        </#if>
