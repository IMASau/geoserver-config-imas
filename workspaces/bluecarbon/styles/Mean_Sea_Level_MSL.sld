...
<StyledLayerDescriptor version="1.0.0" 
  ...
  <NamedLayer>
    <Name>msl_style</Name>
    <UserStyle>
      <Title>Mean Sea Level (MSL) Style</Title>
      <FeatureTypeStyle>
        <Rule>
          <Name>MSL Point</Name>
          <PointSymbolizer>
                ...
                <Fill>
                  <CssParameter name="fill">
                    <ogc:Function name="Interpolate">
                      ...
                      <ogc:Literal>#440154</ogc:Literal> <!-- Deep Purple -->
                      <ogc:Literal>0.2</ogc:Literal>
                      <ogc:Literal>#21908C</ogc:Literal> <!-- Blue-Green -->
                      <ogc:Literal>0.4</ogc:Literal>
                      <ogc:Literal>#fde725</ogc:Literal> <!-- Yellow -->
                      <ogc:Literal>0.6</ogc:Literal>
                      <ogc:Literal>#76da91</ogc:Literal> <!-- Light Green -->
                      <ogc:Literal>0.8</ogc:Literal>
                      <ogc:Literal>#31688e</ogc:Literal> <!-- Light Blue -->
                      <ogc:Literal>1.0</ogc:Literal>
                      <ogc:Literal>#0d0887</ogc:Literal> <!-- Dark Blue -->
