<#list features as feature>
    ...
    <#if (feature_index < 1)>
        <h5 style="padding-top:5px; padding-bottom: 5px;"><img src="https://seamapaustralia.org/map/img/Seamap2_V2_RGB.png" width=105px; style="padding-right:10px">Saltmarsh extent</h5>
