...
<#list features as feature>
    ...
    <#if (feature_index < 1)>
        <div class="feature" style="padding-top: 5px; padding-bottom: 5px; width: 320px;">
            ...
            <br>
            <div id="wesselfeatures" style="white-space: normal; word-wrap: break-word; line-height:1.7; padding-bottom: 5px">
                ...
                <#else>
                    Benthos: <b>${feature.EVENT.value}</b> <i style="color: #9a9a9a; font-size: 95%;">(depth: ${-depth_numeric} m)</i>
		    <br>
                    <i style="color: #9a9a9a; font-size: 98%;">
                        ${feature.DESC.value}
                    </i>
