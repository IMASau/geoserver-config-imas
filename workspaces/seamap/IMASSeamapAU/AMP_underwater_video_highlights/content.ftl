...
<#list features as feature>
    <#if feature.dtype.value == "3D model" && !found3DModel>
        ...
        <iframe
            title="3D benthic model"
            width="640"
            height="440"
            src="${feature.media_URL.value}"
            frameborder="0"
...
<#if !found3DModel>
    ...
    <#list features?sort_by(["sort_order", "rawValue"])?sort_by(["media_type", "rawValue"]) as feature>
        ...
        <!--
            Show YouTube, Vimeo, regional compilations, Port Davey,
            or Lord Howe Island videos. Maximum 2.
        -->
        <#if (
            feature.media_type.value != "file"
            || feature.dtype.value == "regional compilation"
            || feature.regional_location.value?contains("Port Davey")
            || feature.media_URL.value?contains("Hosted/LordHoweIsland")
        ) && foundMedia < 2>
            ...
            <div style="width:560px; text-align:left; overflow-wrap:break-word; word-break:break-word; position:relative;">
                ...
                <!-- View hosted file in new window -->
                <#if feature.media_type.value == "file">
                    <div style="font-size:10px; position:absolute; top:-16px; right:0;">
                        <a
                            style="color:CornflowerBlue;"
                            href="${feature.media_URL.value}"
                            target="_blank">
                            View in new window
                        </a>
                    </div>
                ...
                <div style="word-wrap:break-word; overflow-wrap:break-word; word-break:break-word; padding-bottom:10px; line-height:1.3;">
                    ...
                    <#if feature.description.value?has_content>
                        <i style="white-space:normal; font-size:0.95em;">
                    ...
                    <#if feature.metadata.value?has_content>
                        <a
                            href="${feature.metadata.value}"
                            target="_blank"
                            style="text-decoration:underline; font-size:0.95em;">
                            More Info
                        </a>
                    </#if>
                        ...
                        <#if features?size gt 3>
                            ...
                            <details>
                                ...
                                <summary>
                                    <span
                                        class="summary"
                                        style="cursor:pointer; color:CornflowerBlue; text-decoration:underline; font-size:95%; font-style:italic;">
                                ...
                                <div style="display:flex; flex-wrap:wrap; width:400px; margin-bottom:2px; margin-top:4px;">
                                    ...
                                    <#list features[3..] as thumbnail>
                                        ...
                                        <#if thumbnail_index < 9>
                                            ...
                                            <div
                                                class="thumbnail"
                                                style="width:131px; margin-right:${(thumbnail_index % 3 != 2)?string('3px', '0px')}; margin-bottom:1px;">
                                ...
                                <#if features?size gt 9>
                                    <p style="font-size:11px;">
                                        <i>Zoom in for <b>even more</b> videos at this location!</i>
                                    </p>
                                </#if>
