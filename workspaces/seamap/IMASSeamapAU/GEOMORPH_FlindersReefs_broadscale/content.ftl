...
<#list features as feature>
	...
	<col width="22%" />
  	...
  	<col width="14%" />
            ...
            <tr>
                <td style="text-align: center; white-space: normal; background-color: #d2e5f2;  font-size:11px; ">
                ...
                <td style="text-align: center; white-space: normal; background-color: #d2e5f2; font-size:11px; "> <!-- changed the background color to a pale blue -->
