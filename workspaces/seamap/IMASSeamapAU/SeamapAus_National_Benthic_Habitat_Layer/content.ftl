...
<h5>Seamap Australia v2.1 beta (2023)</h5>
<BR>
  <div class="feature">
	...
	<b>Source (substrata):</b> <#if feature.Data_SC.value == 'NA'><i>no substrata classification</i><#else><a href="${feature.Info_SC.value}" target="_blank">${feature.Data_SC.value}</a> <i>(${feature.Date_SC.value})</i></#if><br>
	<BR>
