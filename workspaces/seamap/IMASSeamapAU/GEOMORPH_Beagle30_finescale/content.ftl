<#list features as feature>
    <#if feature_index == 0> <!-- Always process the first feature -->
        ...
        <#if feature.dataSource.value?matches('.*_BH.*')>
            Fine-scale Classification: Bathymetric <span style="text-decoration: underline; color: #cc0000;">HIGH</span>
        <#else>
            Fine-scale Classification: Bathymetric <span style="text-decoration: underline; color: #0077b3;">LOW</span>
        </#if>
        </h5>
