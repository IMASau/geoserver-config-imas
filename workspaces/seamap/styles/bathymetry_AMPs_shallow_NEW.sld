        ...
        <Rule>
          <RasterSymbolizer>
            <ColorMap type="ramp">
              ...
              <ColorMapEntry color="#fdae35" label="      60" quantity="-60"/>
              <ColorMapEntry color="#f0cc3a" label="      80" quantity="-80"/>
              <ColorMapEntry color="#d7e535" label="     100" quantity="-100"/>
              <ColorMapEntry color="#b6f735" label="     120" quantity="-120"/>
              <ColorMapEntry color="#90ff48" label="     140" quantity="-140"/>
              <ColorMapEntry color="#5cfc70" label="     160" quantity="-160"/>
              <!-- Slope -->
              <ColorMapEntry color="#2df09d" label="     180" quantity="-180"/>
