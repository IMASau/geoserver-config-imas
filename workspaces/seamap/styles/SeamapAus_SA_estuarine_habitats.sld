...
xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <NamedLayer>
    <Name>SA estuarine habitats</Name>
    <UserStyle>
      <Abstract>A style that renders habitat polygons</Abstract>
      <FeatureTypeStyle>
        <Rule>		
          ...
          <PolygonSymbolizer>		
            <Fill>		
              <CssParameter name="fill">#40afbf</CssParameter>		
        ...
        <Rule>		
          ...
          <PolygonSymbolizer>		
            <Fill>		
              <CssParameter name="fill">#e8cdb7</CssParameter>		
              <CssParameter name="fill-opacity">1.0</CssParameter>		
            </Fill>		
          </PolygonSymbolizer>		
        </Rule>        
        <Rule>		
          ...
          <PolygonSymbolizer>		
            <Fill>		
              <CssParameter name="fill">#805500</CssParameter>		
              <CssParameter name="fill-opacity">1.0</CssParameter>		
            </Fill>		
          </PolygonSymbolizer>		
        </Rule>
        ...
        <Rule>		
          ...
          <PolygonSymbolizer>		
            <Fill>		
              <CssParameter name="fill">#c492b7</CssParameter>		
              <CssParameter name="fill-opacity">1.0</CssParameter>		
            </Fill>		
          </PolygonSymbolizer>		
        </Rule>		 		 				
