        ...
        <Rule>
          <RasterSymbolizer>
            <ColorMap type="values">
              ...
              <ColorMapEntry color="#E0A17A" opacity="1" quantity="18" label=" Non-Reef Sediment Epibenthos"/>
              <ColorMapEntry color="#004DA8" opacity="1" quantity="6" label=" Saltmarsh and Reedbeds"/>                                    
              <ColorMapEntry color="#CD7899" opacity="1" quantity="15" label=" Sublittoral Biogenic Reefs"/>   
              <ColorMapEntry color="#F5CA7A" opacity="1" quantity="11" label=" Sublittoral Coarse Sediment"/>                                    
              <ColorMapEntry color="#D7C29E" opacity="1" quantity="14" label=" Sublittoral Mixed Sediments"/>                      
              <ColorMapEntry color="#D7CCBD" opacity="1" quantity="13" label=" Sublittoral Mud"/>         
              <ColorMapEntry color="#B5A881" opacity="1" quantity="20" label=" Sublittoral Mud 2 - Port Phillip Bay"/>              
              <ColorMapEntry color="#FFF0DB" opacity="1" quantity="12" label=" Sublittoral Sand And Muddy Sand"/> 
              <ColorMapEntry color="#F5F57A" opacity="1" quantity="19" label=" Sublittoral Sand 2 - Port Phillip Bay"/> 
              <ColorMapEntry color="#267300" opacity="1" quantity="17" label=" Sublittoral Seagrass Beds"/>
              <ColorMapEntry color="#ABCD66" opacity="1" quantity="16" label=" Sublittoral Seaweed On Sediment"/>                
