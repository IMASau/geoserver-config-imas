        ...
        <Rule>
          <RasterSymbolizer>
            <ColorMap type="ramp">
              ...
              <ColorMapEntry color="#23c4e3" opacity="0.7" label="-350" quantity="-350"/>
              ...
              <ColorMapEntry color="#f0cc3a" opacity="0.7" label="-100" quantity="-100"/>
              <ColorMapEntry color="#fdae35" opacity="0.7" label="-80" quantity="-80"/>
              <ColorMapEntry color="#fc8825" opacity="0.7" label="-60" quantity="-60"/>
              <ColorMapEntry color="#f26014" opacity="0.7" label="-40" quantity="-40"/>
              <ColorMapEntry color="#c52603" opacity="0.7" label="-30" quantity="-30"/>
              <ColorMapEntry color="#a21201" opacity="0.7" label="-20" quantity="-20"/>
