...
<StyledLayerDescriptor
  ...
  <NamedLayer>
    ...
    <UserStyle>
      ...
      <FeatureTypeStyle> 
        <Rule>
          <Title>Available bathymetry data - by resolution</Title>
          <ogc:Filter>
        ...
        <Rule>
          <Title>Available modelled bathymetry - by resolution</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>objectid</ogc:PropertyName>
              <ogc:Literal>intentionallyblank</ogc:Literal>
		...
		<Rule>
          <Title>Surveyed but not currently available</Title>
          <ogc:Filter>
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>objectid</ogc:PropertyName>
              <ogc:Literal>intentionallyblank</ogc:Literal>
