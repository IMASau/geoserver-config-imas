          ...
          <Rule>
            ...
            <!-- specify geometry attribute to pass validation -->
              ...
              <ColorMap type="ramp" >
                ...
                <ColorMapEntry color="#3288bd" quantity="0.4" />
                <ColorMapEntry color="#92d39a" quantity="0.4" />
                <ColorMapEntry color="#d5ff80" quantity="0.4" />                
                <ColorMapEntry color="#fff242" quantity="0.4" />
                <ColorMapEntry color="#fb8650" quantity="0.4" />                
