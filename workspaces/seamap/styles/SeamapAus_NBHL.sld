    ...
    <sld:UserStyle>
      ...
      <sld:FeatureTypeStyle>
        ...
        <sld:Rule>		
          ...
          <sld:PolygonSymbolizer>		
            <sld:Fill>		
              <sld:CssParameter name="fill">#7300e6</sld:CssParameter>		
              <sld:CssParameter name="fill-opacity">1.0</sld:CssParameter>		
            </sld:Fill>		
          </sld:PolygonSymbolizer>		
        </sld:Rule>        
        <sld:Rule>		
          <sld:Title>      Non-Molluscan Filter Feeders</sld:Title>		
          <ogc:Filter>		
            <ogc:PropertyIsEqualTo>		
              <ogc:PropertyName>NAT_HAB_CL</ogc:PropertyName>		
        ...
        <sld:Rule>		
          <sld:Title>      Shelled Biota</sld:Title>		
          <ogc:Filter>		
            <ogc:PropertyIsEqualTo>		
              <ogc:PropertyName>NAT_HAB_CL</ogc:PropertyName>		
          ...
          <sld:PolygonSymbolizer>		
            <sld:Fill>		
              <sld:CssParameter name="fill">#adad85</sld:CssParameter>		
              <sld:CssParameter name="fill-opacity">1.0</sld:CssParameter>		
            </sld:Fill>		
          </sld:PolygonSymbolizer>		
        </sld:Rule>		
        ...
        <sld:Rule>		
          <sld:Title>   Urchin Barren</sld:Title>		
          <ogc:Filter>		
            <ogc:PropertyIsEqualTo>		
              <ogc:PropertyName>NAT_HAB_CL</ogc:PropertyName>		
        ...
        <sld:Rule>		
          <sld:Title>   Unconsolidated Hard Substrata</sld:Title>		
          <ogc:Filter>		
            <ogc:PropertyIsEqualTo>		
              <ogc:PropertyName>NAT_HAB_CL</ogc:PropertyName>		
