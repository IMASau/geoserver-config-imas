  ...
  <NamedLayer>
    ...
    <UserStyle>
      ...
      <FeatureTypeStyle>
        ...
        <Rule>
          <Title>Seagrass (unspecific) / Halophila sp.</Title>
          <ogc:Filter>
            <ogc:PropertyIsLike wildCard='*' singleChar='.' escape='!'>
              <ogc:PropertyName>SM_HAB_CLS</ogc:PropertyName>
              <ogc:Literal>Substrate*Unconsolidated*Seagrasses*Elliptical*Strap*</ogc:Literal>
            </ogc:PropertyIsLike>  
          </ogc:Filter>
          <PolygonSymbolizer>
            <Fill>
        ...
        <Rule>
          <Title>Unconsolidated sediment with sparse vegetation cover</Title>
          <ogc:Filter>
            <ogc:PropertyIsLike wildCard='*' singleChar='.' escape='!'>
              <ogc:PropertyName>SM_HAB_CLS</ogc:PropertyName>
              <ogc:Literal>Substrate*Unconsolidated*Seagrasses</ogc:Literal>
            </ogc:PropertyIsLike>  
          </ogc:Filter>
          <PolygonSymbolizer>
            <Fill>
