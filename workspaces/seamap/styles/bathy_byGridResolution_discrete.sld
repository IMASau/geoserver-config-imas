        ...
        <Rule>
          <RasterSymbolizer>
           <ColorMap type="intervals">
              ...
              <ColorMapEntry color="#92D39A" opacity="0.9" label="    64m [1,280-2,560m]" quantity="-1280"/>             
              <ColorMapEntry color="#3288BD" opacity="0.9" label="    128m [2,560-5,120m]" quantity="-2560"/>             
              <ColorMapEntry color="#2971AD" opacity="0.9" label="    >210m [>5,120m]" quantity="-5120"/>
