	...
	<#else>
		...
		<div class="feature">
			...
			<#elseif feature.GRAY_INDEX.rawValue?string("0") == '21'>
				...
				<br>
				<i>A flat, or sub-horizontal surface</i><b> on </b><i>a spire-shaped pillar, either isolated or rising from a larger feature.</i>		
			...
			<#elseif feature.GRAY_INDEX.rawValue?string("0") == '12'>
				...
				<br>
				<i>A prominent, commonly pointed elevation rising from a larger feature</i><b> on </b><i>a prominent feature rising more than 1000 m above the surrounding relief.</i>
			<#elseif feature.GRAY_INDEX.rawValue?string("0") == '22'>
				<h5>Geomorphic feature: Peak (on Pinnacle)</h5>
				<br>
				<i>A prominent, commonly pointed elevation rising from a larger feature</i><b> on </b><i>a spire-shaped pillar, either isolated or rising from a larger feature.</i>					
			...
			<#elseif feature.GRAY_INDEX.rawValue?string("0") == '13'>
				...
				<br>
				<i>An elongated elevation of varying complexity, size and gradient (length > width)</i><b> on </b><i>a prominent feature rising more than 1000 m above the surrounding relief.</i>
			<#elseif feature.GRAY_INDEX.rawValue?string("0") == '23'>
				<h5>Geomorphic feature: Ridge (on Pinnacle)</h5>
				<br>
				<i>An elongated elevation of varying complexity, size and gradient (length > width)</i><b> on </b><i>a spire-shaped pillar, either isolated or rising from a larger feature.</i>	
			...
			<#elseif feature.GRAY_INDEX.rawValue?string("0") == '14'>
				...
				<br>
				<i>A broad pass in an elevated feature</i><b> on </b><i>a prominent feature rising more than 1000 m above the surrounding relief.</i>
			<#elseif feature.GRAY_INDEX.rawValue?string("0") == '24'>
				<h5>Geomorphic feature: Saddle (on Pinnacle)</h5>
				<br>
				<i>A broad pass in an elevated feature</i><b> on </b><i>a spire-shaped pillar, either isolated or rising from a larger feature.</i>				
			...
			<#elseif feature.GRAY_INDEX.rawValue?string("0") == '15'>
				...
				<br>
				<i>A steep slope, separating areas of relatively lower slope</i><b> on </b><i>a prominent feature rising more than 1000 m above the surrounding relief.</i>
			<#elseif feature.GRAY_INDEX.rawValue?string("0") == '25'>
				<h5>Geomorphic feature: Escarpment (on Pinnacle)</h5>
				<br>
				<i>A steep slope, separating areas of relatively lower slope</i><b> on </b><i>a spire-shaped pillar, either isolated or rising from a larger feature.</i>			
			...
			<#elseif feature.GRAY_INDEX.rawValue?string("0") == '16'>
				...
				<br>
				<i>An inclined surface</i><b> on </b><i>a prominent feature rising more than 1000 m above the surrounding relief.</i>
			<#elseif feature.GRAY_INDEX.rawValue?string("0") == '26'>
				<h5>Geomorphic feature: Slope (on Pinnacle)</h5>
				<br>
				<i>An inclined surface</i><b> on </b><i>a spire-shaped pillar, either isolated or rising from a larger feature.</i>					
			...
			<#elseif feature.GRAY_INDEX.rawValue?string("0") == '17'>
				...
				<br>
				<i>An elongate bathymetric low, generally wide and flat bottomed with symmetrical and subparallel sides</i><b> on </b><i>a prominent feature rising more than 1000 m above the surrounding relief.</i>
			<#elseif feature.GRAY_INDEX.rawValue?string("0") == '27'>
				<h5>Geomorphic feature: Trough (on Pinnacle)</h5>
				<br>
				<i>An elongate bathymetric low, generally wide and flat bottomed with symmetrical and subparallel sides</i><b> on </b><i>a spire-shaped pillar, either isolated or rising from a larger feature.</i>						
			...
			<#elseif feature.GRAY_INDEX.rawValue?string("0") == '18'>
				...
				<br>
				<i>A gently dipping surface, occurring at the base of a bathymetric high, that is elevated relative to the adjacent seafloor</i><b> on </b><i>a prominent feature rising more than 1000 m above the surrounding relief.</i>
			<#elseif feature.GRAY_INDEX.rawValue?string("0") == '28'>
				<h5>Geomorphic feature: Apron (on Pinnacle)</h5>
				<br>
				<i>A gently dipping surface, occurring at the base of a bathymetric high, that is elevated relative to the adjacent seafloor</i><b> on </b><i>a spire-shaped pillar, either isolated or rising from a larger feature.</i>					
			...
			<#elseif feature.GRAY_INDEX.rawValue?string("0") == '19'>
				...
				<br>
				<i>An elongated bathymetric low, typically occurring between prominent bathymetric highs, which generally widens and deepens down-slope</i><b> on </b><i>a prominent feature rising more than 1000 m above the surrounding relief.</i>
			<#elseif feature.GRAY_INDEX.rawValue?string("0") == '29'>
				<h5>Geomorphic feature: Valley (on Pinnacle)</h5>
				<br>
				<i>An elongated bathymetric low, typically occurring between prominent bathymetric highs, which generally widens and deepens down-slope</i><b> on </b><i>a spire-shaped pillar, either isolated or rising from a larger feature.</i>						
			...
			<#elseif feature.GRAY_INDEX.rawValue?string("0") == '20'>
				...
				<br>
				<i>A sub-circular (in planform) bathymetric low with steep walls and a generally flat floor</i><b> on </b><i>a prominent feature rising more than 1000 m above the surrounding relief.</i>
			<#elseif feature.GRAY_INDEX.rawValue?string("0") == '30'>
				<h5>Geomorphic feature: Hole (on Pinnacle)</h5>
				<br>
				<i>A sub-circular (in planform) bathymetric low with steep walls and a generally flat floor</i><b> on </b><i>a spire-shaped pillar, either isolated or rising from a larger feature.</i>				
